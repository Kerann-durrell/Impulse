<?php
    $visuel = [
        'images/clients/cdhb93/VISUEL 1.png',
        'images/clients/cdhb93/VISUEL 2.png',
        'images/clients/cdhb93/VISUEL 3.png',
        'images/clients/cdhb93/VISUEL 4.png',
        'images/clients/cdhb93/VISUEL 5.png',
        'images/clients/cdhb93/VISUEL 6.png',
        'images/clients/cdhb93/VISUEL 7.png',
        'images/clients/cdhb93/VISUEL 8.png',
    ];

    $stories = [
        'images/clients/cdhb93/STORY 1.png',
        'images/clients/cdhb93/STORY 2.png',
        'images/clients/cdhb93/STORY 3.png',
        'images/clients/cdhb93/STORY 4.png',
        'images/clients/cdhb93/STORY 5.png',
        'images/clients/cdhb93/STORY 6.png',
        'images/clients/cdhb93/STORY 7.png',
        'images/clients/cdhb93/STORY 8.png',
        'images/clients/cdhb93/STORY 9.png',
        'images/clients/cdhb93/STORY 10.png',
    ];

    $photographie = [
        'images/clients/cdhb93/PHOTOGRAPHIE 1.png',
        'images/clients/cdhb93/PHOTOGRAPHIE 2.png',
        'images/clients/cdhb93/PHOTOGRAPHIE 3.png',
        'images/clients/cdhb93/PHOTOGRAPHIE 4.png',
        'images/clients/cdhb93/PHOTOGRAPHIE 5.png',
        'images/clients/cdhb93/PHOTOGRAPHIE 6.png',
        'images/clients/cdhb93/PHOTOGRAPHIE 7.png',
        'images/clients/cdhb93/PHOTOGRAPHIE 8.png',
    ];

    $video = [
        'images/clients/cdhb93/VIDEO 1.mp4',
        'images/clients/cdhb93/VIDEO 2.mp4',
    ];
?>
...
<body>
    ...
    <?php
        ...
        if (isset($stories) && is_array($stories)):
            echo '<section id="hero" style="padding: 60px 0; ">
                    <div class="container">
                       <h1 style="color: #11dd9e; font-size: 4rem;">STORIES</h1>
                        <div class="projects-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px;">';

            foreach ($stories as $image) {
                echo '<div class="project-item">
                        <img src="../' . $image . '" alt="Histoire cdhb93 HB" style="width: 100%; border-radius: 8px;">
                      </div>';
            }
        ...
        if (isset($photographie) && is_array($photographie)):
            echo '<section id="hero" style="padding: 60px 0; ">
                    <div class="container">
                       <h1 style="color: #11dd9e;">PHOTOGRAPHIE</h1>
                        <div class="projects-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">';
