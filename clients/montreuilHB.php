<?php
    $visuel = [
        'images/clients/montreuilHB/VISUELS MHB 1.png',
        'images/clients/montreuilHB/VISUELS MHB 2.png',
        'images/clients/montreuilHB/VISUELS MHB 3.png',
        'images/clients/montreuilHB/VISUELS MHB 4.png',
        'images/clients/montreuilHB/VISUELS MHB 5.png',
        'images/clients/montreuilHB/VISUELS MHB 6.png',
        'images/clients/montreuilHB/VISUELS MHB 7.png',
        'images/clients/montreuilHB/VISUELS MHB 8.png',
    ];

    $photographie = [
        'images/clients/montreuilHB/PHOTOGRAPHIE 1.png',
        'images/clients/montreuilHB/PHOTOGRAPHIE 2.png',
        'images/clients/montreuilHB/PHOTOGRAPHIE 3.png',
        'images/clients/montreuilHB/PHOTOGRAPHIE 4.png',
        'images/clients/montreuilHB/PHOTOGRAPHIE 5.png',
        'images/clients/montreuilHB/PHOTOGRAPHIE 6.png',
        'images/clients/montreuilHB/PHOTOGRAPHIE 7.png',
        'images/clients/montreuilHB/PHOTOGRAPHIE 8.png',
    ];

    $video = [
        'images/clients/montreuilHB/VIDEO 1.mp4',
        'images/clients/montreuilHB/VIDEO 2.mp4',
        'images/clients/montreuilHB/VIDEO 3.mp4',
    ];
?>
...
<body>
    ...
    <?php
        ...
        if (isset($photographie) && is_array($photographie)):
            echo '<section id="hero" style="padding: 60px 0; ">
                    <div class="container">
                       <h1 style="color: #11dd9e; ">PHOTOGRAPHIES</h1>
                        <div class="projects-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">';
