<?php
    $photographie = [
        'images/clients/rosny/PHOTOS 1.png',
        'images/clients/rosny/PHOTOS 2.png',
        'images/clients/rosny/PHOTOS 3.png',
        'images/clients/rosny/PHOTOS 4.png',
        'images/clients/rosny/PHOTOS 5.png',
        'images/clients/rosny/PHOTOS 6.png',
        'images/clients/rosny/PHOTOS 7.png',
        'images/clients/rosny/PHOTOS 8.png',
        'images/clients/rosny/PHOTOS 9.png',
        'images/clients/rosny/PHOTOS 10.png',
        'images/clients/rosny/PHOTOS 11.png',
        'images/clients/rosny/PHOTOS 12.png',
        'images/clients/rosny/PHOTOS 13.png',
        'images/clients/rosny/PHOTOS 14.png',
        'images/clients/rosny/PHOTOS 15.png',
        'images/clients/rosny/PHOTOS 16.png',
        'images/clients/rosny/PHOTOS 17.png',
        'images/clients/rosny/PHOTOS 18.png',
        'images/clients/rosny/PHOTOS 19.png',
        'images/clients/rosny/PHOTOS 20.png',
    ];
...
<body>
    ...
    <?php
        ...
        if (isset($photographie) && is_array($photographie)):
            echo '<section id="hero" style="padding: 60px 0; overflow-x: hidden; text-overflow: ellipsis; white-space: nowrap;">
                    <div class="container">
                       <h1 style="color: #11dd9e; text-wrap: no-wrap; text-overflow: ellipsis; white-space: nowrap;">PHOTOGRAPHIES</h1>
                        <div class="projects-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">';
