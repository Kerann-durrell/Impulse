<?php
    $visuel = [
        'images/clients/villemobile/VISUEL 1.png',
        'images/clients/villemobile/VISUEL 2.png',
        'images/clients/villemobile/VISUEL 3.png',
        'images/clients/villemobile/VISUEL 4.png',
        'images/clients/villemobile/VISUEL 5.png',
        'images/clients/villemobile/VISUEL 6.png',
        'images/clients/villemobile/VISUEL 7.png',
        'images/clients/villemobile/VISUEL 8.png',
    ];

    $photographie = [
        'images/clients/villemobile/PHOTOGRAPHIE 1.png',
        'images/clients/villemobile/PHOTOGRAPHIE 2.png',
        'images/clients/villemobile/PHOTOGRAPHIE 3.png',
        'images/clients/villemobile/PHOTOGRAPHIE 4.png',
        'images/clients/villemobile/PHOTOGRAPHIE 5.png',
        'images/clients/villemobile/PHOTOGRAPHIE 6.png',
        'images/clients/villemobile/PHOTOGRAPHIE 7.png',
        'images/clients/villemobile/PHOTOGRAPHIE 8.png',
    ];

    $video = [
        'images/clients/villemobile/VIDEO 1.mp4',
        'images/clients/villemobile/VIDEO 2.mp4',
        'images/clients/villemobile/VIDEO 3.mp4',
    ];
?>
